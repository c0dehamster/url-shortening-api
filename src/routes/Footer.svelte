...
<footer class="footer">
	...
	<nav class="footer-nav">
		<ul class="footer-nav__section">
			...
			<li class="footer-nav__list-item">
				<a href="#0" class="link">Link Shortening</a>
			</li>

			<li class="footer-nav__list-item">
				<a href="#0" class="link">Branded Links</a>
			</li>

			<li class="footer-nav__list-item">
				<a href="#0" class="link">Analytics</a>
			</li>
		</ul>
		...
		<ul class="footer-nav__section">
			...
			<li class="footer-nav__list-item">
				<a href="#0" class="link">Developers</a>
			</li>

			<li class="footer-nav__list-item">
				<a href="#0" class="link">Support</a>
			</li>
		</ul>
		...
		<ul class="footer-nav__section">
			...
			<li class="footer-nav__list-item">
				<a href="#0" class="link">Our Team</a>
			</li>
	...
	<ul class="social-links">
		<li class="social-links__item">
			<a href="#0" class="social-links__link" aria-label="facebook">
				<svg
			...
			<a href="#0" class="social-links__link" aria-label="Twitter">
				<svg
					class="social-links__icon"
					xmlns="http://www.w3.org/2000/svg"
					width="24"
			...
			<a href="#0" class="social-links__link" aria-label="Pinterest">
				<svg
					class="social-links__icon"
					xmlns="http://www.w3.org/2000/svg"
					width="24"
			...
			<a href="#0" class="social-links__link" aria-label="Instagram">
				<svg
					class="social-links__icon"
					xmlns="http://www.w3.org/2000/svg"
					width="24"
